...
# 1. 字母x - 举足轻重
## 1. x与css中的baseline(vertical-align)
## 2. x与x-height
## 3. x与ex
...
![avatar](../images/css/css-world/5.1.png)
...
- line-height会影响替换元素的高度吗？ 不会，规范中有提到计算行框高度时
    ...
    ![avatar](../images/css/css-world/5.3.png)
...
2. 如何实现多行文本或者图片等替换元素的（近似）垂直居中效果？ 
    ...
    [参考](http://demo.cssworld.cn/5/2-4.php)
...
3. line-height支持的三种类型的区别？http://demo.cssworld.cn/5/2-5.php
...
[参考](http://demo.cssworld.cn/5/2-6.php)

![avatar](../images/css/css-world/5.7.png)
...
# 3. vertical-align
[参考](https://www.cnblogs.com/shireyhu/p/7832335.html)
...
2. 图片底部留有空隙：http://demo.cssworld.cn/5/3-2.php（任意一个块级元素，里面若有图片，则块级元素高度基本都要比图片的高度高（http://demo.cssworld.cn/5/3-5.php
...
![avatar](../images/css/css-world/5.8.png)
